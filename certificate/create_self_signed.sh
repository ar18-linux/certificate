...
{
  # Script template version 2021-07-14_00:23:47
...
cert_dir="/etc/self-signed-certificates"
domain_or_ip="ar18.spdns.org"

function ar18_extra_cleanup(){
  ar18.script.execute_with_sudo rm -rf "${temp_dir}"
  ar18.script.execute_with_sudo rm -f "${cert_dir}/${domain_or_ip}"
}
...
ar18.script.execute_with_sudo chmod +x "${script_dir}/exprect_openssl.tcl"
